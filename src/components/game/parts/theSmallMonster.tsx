...
import { useSmallMonsterBattle } from "../../../hooks/use-small-monster-battle";
import { store } from "../../../store";
import Button from "../../reusable/button";
import Icon from "../../reusable/icon";

export default function TheSmallMonsterPart() {
  useScreenScroll();
  const title = useAnimatedText("The Small Monster");
  const { battle, startBattleStartTimer, playerAttack, tryAgain, monster } =
    useSmallMonsterBattle();
    ...
    <PartContainer>
      ...
      <PartActions>
        ...
        >
          <PartButton
            onClick={() => {
              store.parts.setSmallMonsterRewardActive(true);
            }}
          >
            Continue
          </PartButton>
